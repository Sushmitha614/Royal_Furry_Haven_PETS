        ...
        <Card sx={{ borderRadius: 3, boxShadow: 3, p: 2 }}>
          <CardContent>
            ...
            <Box component="form" display="flex" flexDirection="column" gap={2}>
              <TextField label="Category Name" required fullWidth defaultValue="Dog Food" />
              <TextField label="Description" multiline rows={3} fullWidth defaultValue="Premium dog food for all breeds." />
              <Button
                variant="outlined"
                component="label"
